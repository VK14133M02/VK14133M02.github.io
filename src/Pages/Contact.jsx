...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    emailjs
      .send("service_vd9bcyd", "template_busulwl", values, "J7ods_sXFuL8RnKNI")
      .then(
        (response) => {
  ...
  return (
    <Box bg={bg} p={["0px", "30px", "40px"]} name="contact">
      <Heading my={10} pt={10} color="#F5C32C" textAlign="center">
        Get in Touch
      </Heading>
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            ...
            <Button
              ...
              m="auto"
              color="white"
              bg="linear-gradient(135deg, #f34079 40%, #fc894d)"
              mt={5}
