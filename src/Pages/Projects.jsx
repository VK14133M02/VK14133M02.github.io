        ...
        >
          ...
          <Box data-aos="fade-up" data-aos-duration="1500">
            <Box p={3}>
              ...
              <div>
                <Text color="white">
                  Apple Tv+ is an OTT platform where you can watch Hollywood web
                  series & tv shows.
                </Text>
              </div>
              ...
              <Text fontSize={"large"} color="white">
                I created HomePage, Signup & Login page , user can play the
                video. I cloned it in 5 Day's. I named it RiVic Tv & i desined a
                logo for it
              </Text>
              ...
              <Flex mt={5} justify="center" gap={10}>
                ...
                <a
                  href="https://github.com/VK14133M02/-graceful-lunch-5485"
                  target="blank"
                >
                  <Image
                    w="40px"
        ...
        >
          ...
          <Box data-aos="fade-up" data-aos-duration="1500">
            <Box p={3}>
              ...
              <div>
                <Text color="white">
                  This is an e-commerce website named NORDSTROM rack. Users can
                  search for products, view product details, and add products to
                  the cart.
                </Text>
              </div>
              <Text fontSize={"large"} color="white">
              ...
              <Text fontSize={"large"} color="white">
                I created all category page, such as kids section , womens
                section , mens section. product page , where you can add to
                card.{" "}
              </Text>

              <Flex mt={5} justify="center" gap={10}>
                <a
                  href="https://superb-alfajores-ceed5f.netlify.app/"
                  target="blank"
                >
                  <Image
                    w="40px"
                ...
                <a
                  href="https://github.com/gunjankuthe111/Nordstromrack.com"
                  target="blank"
                >
                  <Image
                    w="40px"
        ...
        >
          ...
          <Box data-aos="fade-up" data-aos-duration="1500">
            <Box p={3}>
              ...
              <div>
                <Text color="white">
                  Indiegogo is an American crowdfunding website. Indiegogo
                  allows people to solicit funds for an idea, charity, or
                  start-up business.{" "}
                </Text>
              </div>
              <Text fontSize={"large"} color="white">
              ...
              <Text fontSize={"large"} color="white">
                I created Home Page, slider , text on background image. i cloned
                it in 4 day's
              </Text>

              <Flex mt={5} justify="center" gap={10}>
                <a
                  href="https://exquisite-douhua-e9fc71.netlify.app/"
                  target="blank"
                >
                  <Image
                    w="40px"
                ...
                <a
                  href="https://github.com/3003abhishek/daily-wound-486"
                  target="blank"
                >
                  <Image
                    w="40px"
        ...
        >
          ...
          <Box data-aos="fade-up" data-aos-duration="1500">
            <Box p={3}>
              ...
              <div>
                <Text color="white">
                  myHours is a project tracking website where you can track your
                  group project , what is the work progress , how much time time
                  to complete the project, budget of the project.
                </Text>
              </div>
              <Text fontSize={"large"} color="white">
                It is an indivisual project.
              ...
              <Text fontSize={"large"} color="white">
                I created Navbar, Home page , Register & Login page , Footer.{" "}
              </Text>

              <Flex mt={5} justify="center" gap={10}>
                <a
                  href="https://taupe-selkie-12eb45.netlify.app/"
                  target="blank"
                >
                  <Image
                    w="40px"
                ...
                <a
                  href="https://github.com/VK14133M02/gold-kick-1985"
                  target="blank"
                >
                  <Image
                    w="40px"
